import { ICandelStickData, IHaveCandleStickData } from "./interfaces";
...
export abstract class CandelStickBase implements IHaveCandleStickData {
    constructor(data?: ICandelStickData | IHaveCandleStickData) {
        const _data: ICandelStickData = data == null ? null
...
export class CandleStickArrayModel extends CandelStickBase implements IHaveCandleStickData {
